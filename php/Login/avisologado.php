...
<body>
    ...
    <div class="jumbotron text-center">
        ...
        <p class="lead animate__heartBeat">Verificamos que você já está logado!</p>
        <p class="lead animate__heartBeat">Finalize sua seção para poder efetuar o login usando outra conta.</p>
        <hr class="my-4">
    <div class="mt-3">
