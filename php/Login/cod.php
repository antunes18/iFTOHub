...
<body>
    ...
    <div class="jumbotron text-center">
        <form action="cod.php" method="POST" autocomplete="off">
            <label class="lead" for="codv">Digite o código de verificação aqui:</label><br>
            <input class="form-control w-50 m-auto" placeholder="Código de verificação..."placeholder="Código de verificação..." type="text" name="codv" required>
